-- Enhanced Timeline Manager Migration (FIXED - Idempotent)
...
DROP POLICY IF EXISTS "Users can view their own templates and system defaults" ON timeline_templates;
...
DROP POLICY IF EXISTS "Users can insert their own templates" ON timeline_templates;
CREATE POLICY "Users can insert their own templates"
  ON timeline_templates FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own templates" ON timeline_templates;
CREATE POLICY "Users can update their own templates"
  ON timeline_templates FOR UPDATE
  USING (auth.uid() = user_id)
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their own templates" ON timeline_templates;
CREATE POLICY "Users can delete their own templates"
  ON timeline_templates FOR DELETE
  USING (auth.uid() = user_id AND is_system_default = FALSE);

-- Timeline Goals Policies
DROP POLICY IF EXISTS "Users can view their own goals" ON timeline_goals;
CREATE POLICY "Users can view their own goals"
  ON timeline_goals FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own goals" ON timeline_goals;
CREATE POLICY "Users can insert their own goals"
  ON timeline_goals FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own goals" ON timeline_goals;
CREATE POLICY "Users can update their own goals"
  ON timeline_goals FOR UPDATE
  USING (auth.uid() = user_id)
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their own goals" ON timeline_goals;
CREATE POLICY "Users can delete their own goals"
  ON timeline_goals FOR DELETE
  USING (auth.uid() = user_id);

-- Timeline Goal Items Policies
DROP POLICY IF EXISTS "Users can view goal items for their goals" ON timeline_goal_items;
...
DROP POLICY IF EXISTS "Users can insert goal items for their goals" ON timeline_goal_items;
...
DROP POLICY IF EXISTS "Users can update goal items for their goals" ON timeline_goal_items;
...
DROP POLICY IF EXISTS "Users can delete goal items for their goals" ON timeline_goal_items;
...
DROP POLICY IF EXISTS "Users can view their own AI sessions" ON timeline_ai_sessions;
CREATE POLICY "Users can view their own AI sessions"
  ON timeline_ai_sessions FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own AI sessions" ON timeline_ai_sessions;
CREATE POLICY "Users can insert their own AI sessions"
  ON timeline_ai_sessions FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own AI sessions" ON timeline_ai_sessions;
...
DROP TRIGGER IF EXISTS timeline_templates_updated_at ON timeline_templates;
...
DROP TRIGGER IF EXISTS timeline_goals_updated_at ON timeline_goals;
...
DROP TRIGGER IF EXISTS update_goal_hours_trigger ON timeline_goal_items;
