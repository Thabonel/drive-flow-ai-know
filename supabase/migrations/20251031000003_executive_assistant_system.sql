-- Executive-Assistant System and Document Management
...
CREATE INDEX idx_user_roles_subscription_tier ON user_roles(subscription_tier);

-- assistant_relationships indexes
CREATE INDEX idx_assistant_relationships_executive_id ON assistant_relationships(executive_id);
CREATE INDEX idx_assistant_relationships_assistant_id ON assistant_relationships(assistant_id);
...
CREATE INDEX idx_timeline_documents_uploaded_by ON timeline_documents(uploaded_by_user_id);
CREATE INDEX idx_timeline_documents_for_user ON timeline_documents(for_user_id);
CREATE INDEX idx_timeline_documents_upload_date ON timeline_documents(upload_date DESC);
CREATE INDEX idx_timeline_documents_document_date ON timeline_documents(document_date DESC);
CREATE INDEX idx_timeline_documents_tags ON timeline_documents USING gin(tags);
CREATE INDEX idx_timeline_documents_category ON timeline_documents(category);
CREATE INDEX idx_timeline_documents_confidential ON timeline_documents(for_user_id, is_confidential);

-- timeline_item_documents indexes
CREATE INDEX idx_timeline_item_documents_item_id ON timeline_item_documents(timeline_item_id);
CREATE INDEX idx_timeline_item_documents_document_id ON timeline_item_documents(document_id);
CREATE INDEX idx_timeline_item_documents_added_by ON timeline_item_documents(added_by_user_id);
CREATE INDEX idx_timeline_item_documents_type ON timeline_item_documents(attachment_type);

-- executive_daily_briefs indexes
CREATE INDEX idx_executive_daily_briefs_executive_id ON executive_daily_briefs(executive_id);
CREATE INDEX idx_executive_daily_briefs_brief_date ON executive_daily_briefs(brief_date DESC);
CREATE INDEX idx_executive_daily_briefs_status ON executive_daily_briefs(executive_id, status);
CREATE INDEX idx_executive_daily_briefs_prepared_by ON executive_daily_briefs(prepared_by_assistant_id);

-- assistant_audit_log indexes
CREATE INDEX idx_assistant_audit_log_actor ON assistant_audit_log(actor_user_id);
CREATE INDEX idx_assistant_audit_log_target ON assistant_audit_log(target_user_id);
CREATE INDEX idx_assistant_audit_log_action ON assistant_audit_log(action);
CREATE INDEX idx_assistant_audit_log_resource ON assistant_audit_log(resource_type, resource_id);
CREATE INDEX idx_assistant_audit_log_created_at ON assistant_audit_log(created_at DESC);
CREATE INDEX idx_assistant_audit_log_actor_target ON assistant_audit_log(actor_user_id, target_user_id, created_at DESC);
...
BEGIN
  ...
  RAISE NOTICE '================================================';
  RAISE NOTICE 'Executive-Assistant System Migration';
  RAISE NOTICE '================================================';
